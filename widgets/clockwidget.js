// Defer init until storage cache is populated (widget reads LS in loadState).
(typeof _storageReady !== 'undefined' ? _storageReady : Promise.resolve())
  .then(function _initClockWidget() {
...
<div class="widget" id="widget-clockwidget" style="display:none;">
  ...
  function loadState() { return LS.get(STORE_KEY, {}); }
  function saveState(s) { LS.set(STORE_KEY, s); }
