...
// Wire the base widget immediately — the HTML already has #widget-todo so
// injectTodoHTML above is a no-op, but initWidget_todo still needs to run.
window.initWidget_todo();